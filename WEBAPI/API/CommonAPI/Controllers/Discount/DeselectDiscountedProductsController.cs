 ...
 * Description  - API for the De-Select Discounted Products Operation.
 *  
 **************
 **Version Log
 **************
...
{
    public class DeselectDiscountedProductsController : ApiController
    {
        private Semnox.Parafait.logging.Logger log;

        /// <summary>
        /// API for the Clear Discounted Products Operation.
        /// </summary>
        /// <param name="discountId">discountId</param>
        /// <returns>HttpMessgae</returns>
        [HttpPost]
        [Route("api/Discount/DeselectDiscountedProducts")]
        [Authorize]
        public async Task<HttpResponseMessage> Post([FromBody]int discountId)
        {
            ...
            try
            {
                ...
                await discountUseCases.DeselectDiscountedProducts(discountId);
                log.LogMethodExit();
