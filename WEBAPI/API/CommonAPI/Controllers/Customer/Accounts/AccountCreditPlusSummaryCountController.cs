...
{
    public class AccountCreditPlusSummaryCountController : ApiController
    {
        ...
        /// </summary>       
        [HttpGet]
        [Route("api/Customer/Account/AccountCreditPlusSummaryCount")]
        public async Task<HttpResponseMessage> Get(int accountId = -1, string accountNumber = null, DateTime? fromDate = null, DateTime? toDate = null, string creditPlusType = null, bool showExpiryEntitlements = false)
        {
            try
            {
                ...
                int count = await accountUseCases.GetAccountCreditPlusSummaryDTOListCount(accountId, accountNumber, fromDate, toDate, creditPlusType, showExpiryEntitlements);
