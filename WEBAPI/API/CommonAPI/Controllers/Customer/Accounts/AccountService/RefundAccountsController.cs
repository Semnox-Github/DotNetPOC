 ...
 * Description  - API for the Refund the account
 * 
 **************
 **Version Log
 **************
...
{
    public class RefundAccountsController : ApiController
    {
        ...
        [HttpPost]
        [Route("api/Customer/Account/AccountService/RefundAccounts")]
        [Authorize]
        public HttpResponseMessage Post([FromBody] AccountServiceDTO accountServiceDTO)
        {
            ...
            try
            {
                ...
                {
                    RefundAccountBL refundAccountBL = new RefundAccountBL(executionContext, accountServiceDTO);
                    refundAccountBL.Refund();
                    log.LogMethodExit();
