 ...
 * Description  - API for the Redeem Bonus to tickets and visa-versa
 * 
 **************
 **Version Log
 **************
...
{
    public class RedeemBonusAndTicketsController : ApiController
    {
        private static readonly Semnox.Parafait.logging.Logger log = new Semnox.Parafait.logging.Logger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        
        [HttpPost]
        [Route("api/Customer/Account/AccountService/RedeemBonusAndTickets")]
        [Authorize]
        public HttpResponseMessage Post([FromBody] AccountServiceDTO accountServiceDTO)
        {
            ...
            try
            {
                ...
                {
                    RedeemBonusAndTicketBL redeemBonusAndTicketBL = new RedeemBonusAndTicketBL(executionContext, accountServiceDTO);
                    redeemBonusAndTicketBL.RedeemEntitlements();
                    log.LogMethodExit();
