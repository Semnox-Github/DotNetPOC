 ...
 *2.70.0      17-Sept-2019    Jagan Mohana        Renamed CardsManagementController to TagInventoryController
 ********************************************************************************************/
...
{
    public class TokenCardInventoryController : ApiController
    {
        ...
        [HttpGet]
        [Authorize]
        [Route("api/Customer/Account/TokenCardInventory")]
        public HttpResponseMessage Get(string activityType, string fromDate = null, string toDate = null)
        {
            ...
            try
            {
                log.LogMethodEntry(activityType, fromDate, toDate);
                ...
                if (activityType.ToUpper().ToString() == "ADDCARDS" || activityType.ToUpper().ToString() == "DELETECARDS")
                {
                ...
                else if (activityType.ToUpper().ToString() == "TOKENCARDINVENTORY")
                {
                ...
                else if (activityType.ToUpper().ToString() == "VIEWINVENTORY" && !string.IsNullOrEmpty(fromDate) && !string.IsNullOrEmpty(toDate))
                {
