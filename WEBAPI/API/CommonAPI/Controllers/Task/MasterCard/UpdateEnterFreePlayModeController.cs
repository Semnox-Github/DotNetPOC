 ...
 * Description  - Controller to update enter free play mode
 * 
 **************
 **Version Log
 **************
...
{
    public class UpdateEnterFreePlayModeController : ApiController
    {
        private static readonly Semnox.Parafait.logging.Logger log = new Semnox.Parafait.logging.Logger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        private ExecutionContext executionContext;

        [HttpPut]
        [Route("api/Task/MasterCard/UpdateEnterFreePlayMode")]
        [Authorize]
        ...
        public async Task<HttpResponseMessage> Put([FromBody] CardConfigurationDTO cardConfigurationDTO)
        {
            try
            {
                ...
                string result = await taskUseCases.UpdateEnterFreePlayMode(cardConfigurationDTO);
