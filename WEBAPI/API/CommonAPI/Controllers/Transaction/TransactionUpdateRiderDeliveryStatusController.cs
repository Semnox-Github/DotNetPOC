...
* Description  - API for the TransactionUpdateRiderDeliveryStatus Controller.
* 
**************
**Version Log
**************
...
{
    public class TransactionUpdateRiderDeliveryStatusController : ApiController
    {
        private static readonly Semnox.Parafait.logging.Logger log = new Semnox.Parafait.logging.Logger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        private ExecutionContext executionContext;
        [HttpPost]
        [Route("api/Transaction/{transactionId}/UpdateRiderDeliveryStatus")]
        [Authorize]
        public async Task<HttpResponseMessage> Post([FromBody]List<TransactionDeliveryDetailsDTO> transactionDeliveryDetailsDTOList, [FromUri] int transactionId)
        {
            ...
            try
            {
                ...
                if (transactionDeliveryDetailsDTOList != null && transactionId > -1)
                {
                    ...
                    TransactionOrderDispensingDTO result = await transactionUseCases.SaveRiderDeliveryStatus(transactionId, transactionDeliveryDetailsDTOList);
