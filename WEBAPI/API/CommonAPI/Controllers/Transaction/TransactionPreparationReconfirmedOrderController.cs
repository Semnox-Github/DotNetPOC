...
* Description  - API for the TransactionPreparationReconfirmedOrder Controller.
* 
**************
**Version Log
**************
...
{
    public class TransactionPreparationReconfirmedOrderController : ApiController
    {
        private static readonly Semnox.Parafait.logging.Logger log = new Semnox.Parafait.logging.Logger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        private ExecutionContext executionContext;
        [HttpPost]
        [Route("api/Transaction/Transactions/PreparationReconfirmedOrder")]
        [Authorize]
        public async Task<HttpResponseMessage> Post([FromBody]List<TransactionDTO> inputList)
        {
            ...
            try
            {
                ...
                if (inputList != null && inputList.Any())
                {
                    ...
                    List<KeyValuePair<TransactionDTO, string>> resultList = await transactionUseCases.SetAsPreparationReconfirmedOrder(inputList);
