...
{
    public class TransactionUpdatePaymentModeDetailsController : ApiController
    {
        ...
        [HttpPost]
        [Route("api/Transaction/UpdateTransactionPaymentMode")]
        [Authorize]
        public async Task<HttpResponseMessage> Post([FromBody] List<TransactionPaymentsDTO> transactionPaymentsDTOList)
        {
            ...
            try
            {
                ...
                if (transactionPaymentsDTOList != null && transactionPaymentsDTOList.Count > 0)
                {
                    ...
                    var content = await transactionUseCases.UpdateTransactionPaymentModeDetails(transactionPaymentsDTOList);
                    log.LogMethodExit();
