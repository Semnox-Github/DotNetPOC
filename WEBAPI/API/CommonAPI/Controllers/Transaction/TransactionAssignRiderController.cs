...
{
    public class TransactionAssignRiderController : ApiController
    {
        private static readonly Semnox.Parafait.logging.Logger log = new Semnox.Parafait.logging.Logger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        private ExecutionContext executionContext;
        [HttpPost]
        [Route("api/Transaction/{transactionId}/AssignRider")]
        [Authorize]
        public async Task<HttpResponseMessage> Post([FromBody]TransactionDeliveryDetailsDTO transactionDeliveryDetailsDTO, [FromUri] int transactionId)
        {
            ...
            try
            {
                ...
                if (transactionDeliveryDetailsDTO != null && transactionId > -1)
                {
                    ...
                    TransactionOrderDispensingDTO result = await transactionUseCases.AssignRider(transactionId, transactionDeliveryDetailsDTO);
