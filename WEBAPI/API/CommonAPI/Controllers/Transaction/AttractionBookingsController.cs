...
{
    public class AttractionBookingsController : ApiController
    {
        ...
        [HttpPost]
        [Authorize]
        [Route("api/Transaction/AttractionBookings")]
            ...
            try
            {
                ...
                if (attractionBookingDTOList != null && attractionBookingDTOList.Any())
                {
                    ...
                    foreach (AttractionBookingDTO atbDTO in attractionBookingDTOList)
                    {
                        ...
                        offSetDuration = timeZoneUtil.GetOffSetDuration(executionContext.GetSiteId(), scheduleDate);
                                       ...
                                       DateTime? attractionFromDate = null)
        {
            ...
            try
            {
                ...
                if (attractionFromDate != null)
                {
                    ...
                    searchParameters.Add(new KeyValuePair<AttractionBookingDTO.SearchByParameters, string>(AttractionBookingDTO.SearchByParameters.ATTRACTION_DATE, dateTime.ToString("yyyy-MM-dd HH:mm:ss", CultureInfo.InvariantCulture)));
                }
