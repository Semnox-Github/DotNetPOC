/********************************************************************************************
 * Project Name -  ConsolidateTicket Controller
 * Description  -  
 *  
 **************
 **Version Log
...
{
    public class ConsolidateTicketController : ApiController
    {
        ...
        /// <returns></returns>
        [HttpPost]
        [Route("api/Redemption/RedemptionOrder/{orderId}/Consolidate")]
        [Authorize]
        public async Task<HttpResponseMessage> Post([FromUri] int orderId, [FromBody] RedemptionActivityDTO redemptionActivityDTO)
        {
            ...
            try
            {
                ...
                if (redemptionActivityDTO != null)
                {
                    ...
                    RedemptionDTO content = await redemptionUseCases.ConsolidateTicketReceipts(orderId ,redemptionActivityDTO);
                    log.LogMethodExit();
