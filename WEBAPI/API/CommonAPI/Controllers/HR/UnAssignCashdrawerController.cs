/**************************************************************************************************
 * Project Name - HR 
 * Description  - Controller for UnA ssignCashdrawer for the shift
 *  
 **************
 **Version Log
 **************
...
{
    public class UnAssignCashdrawerController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> Post([FromUri] int shiftId, [FromBody] CashdrawerActivityDTO cashdrawerActivityDTO)
        {
            ...
            try
            {
                ...
                ShiftDTO shiftDTO = await shiftUseCases.UnAssignCashdrawer(shiftId, cashdrawerActivityDTO);
