...
{
    public class GameMachineImageNamesController : ApiController
    {
        ...
        [HttpGet]
        [Authorize]
        [Route("api/Game/GameMachineImages")]
        public async Task<HttpResponseMessage> Get(string machineName = null,string fileName =null)
        {
            log.LogMethodEntry(machineName);
                ...
                List<string> fileNames = await virtualArcadeUseCases.GetGameMachineImages(machineName, fileName);
                log.LogMethodExit();
