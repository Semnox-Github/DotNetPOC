/********************************************************************************************
 * Project Name - Game
 * Description  - Created to Attach AdShowContext
 *  
 **************
 **Version Log
 **************
...
{
    public class AttachAdShowContextController : ApiController
    {
        private static readonly Semnox.Parafait.logging.Logger log = new Semnox.Parafait.logging.Logger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        /// <summary>
        /// Get the JSON AttachAdShowContext
        /// </summary>       
        /// <returns>HttpResponseMessage</returns>
        [HttpGet]
        [Authorize]
        [Route("api/Game/AdManagement/{hubId}/AttachAdShowContext")]
        public async Task<HttpResponseMessage> Get([FromUri]int hubId = -1, int machineId = -1)
        {
            ...
            try
            {
                ...
                if (hubId > -1)
                {
                    ...
                    await adUseCases.AttachAdShowContext(hubId, machineId);
                    log.LogMethodExit();
