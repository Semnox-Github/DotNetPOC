/********************************************************************************************
 * Project Name - Game
 * Description  - Created to Attach AdContext
 *  
 **************
 **Version Log
 **************
...
{
    public class AttachAdContextController : ApiController
    {
        private static readonly Semnox.Parafait.logging.Logger log = new Semnox.Parafait.logging.Logger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        /// <summary>
        /// Get the JSON AttachAdContext
        /// </summary>       
        /// <returns>HttpResponseMessage</returns>
        [HttpGet]
        [Authorize]
        [Route("api/Game/AdManagement/{hubId}/AttachAdContext")]
        public async Task<HttpResponseMessage> Get([FromUri]int hubId = -1, int machineId = -1)
        {
            ...
            try
            {
                ...
                if (hubId > -1)
                {
                    ...
                    await adUseCases.AttachAdContext(hubId, machineId);
                    log.LogMethodExit();
