/********************************************************************************************
 * Project Name - Game
 * Description  - Created to Get AdShowContext
 *  
 **************
 **Version Log
 **************
...
{
    public class AdShowContextController : ApiController
    {
        private static readonly Semnox.Parafait.logging.Logger log = new Semnox.Parafait.logging.Logger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        /// <summary>
        /// Get the JSON AdShowContext
        /// </summary>       
        /// <returns>HttpResponseMessage</returns>
        [HttpGet]
        [Authorize]
        [Route("api/Game/AdManagement/{hubId}/AdShowContext")]
        public async Task<HttpResponseMessage> Get([FromUri]int hubId = -1, int machineId = -1)
        {
            ...
            try
            {
                ...
                if (hubId > -1)
                {
                    ...
                    await adUseCases.GetAdShowContext(hubId, machineId);
                    log.LogMethodExit();
