                ...
                try
                {
                    if (KioskStatic.ShowTickets)
                    {
                        if (!string.IsNullOrEmpty(eaterTickets.ToString()) && Convert.ToDouble(eaterTickets) > 0)
                        {
                            ...
                            lblTicketsCourtesy.Location = new Point(775, 79);
                            lblEaterTickets.Location = new Point(870, 43);
                            label4.Location = new Point(273, 76); //gamelabel
                            label5.Location = new Point(460, 41); // game price
                            label6.Location = new Point(635, 41); // game points 
