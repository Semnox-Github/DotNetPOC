...
namespace Parafait_Kiosk
{
    public partial class frmFAQ : BaseFormKiosk
    {
        ...
        public frmFAQ()
        {
            ...
            this.BackgroundImage = ThemeManager.GetBackgroundImage(ThemeManager.CurrentThemeImages.FAQBackgroundImage);//Starts:Modification on 17-Dec-2015 for introducing new theme
