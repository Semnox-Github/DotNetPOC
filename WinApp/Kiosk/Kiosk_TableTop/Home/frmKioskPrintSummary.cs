    ...
    public partial class frmKioskPrintSummary : BaseForm
    {
        ...
        private void KioskPrintSummary_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                pnlFromToDates.Location = new System.Drawing.Point(3, 121);
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string deliveryMode = ParafaitDefaultContainerList.GetParafaitDefault(KioskStatic.Utilities.ExecutionContext, "KIOSK_RECEIPT_DELIVERY_MODE");
                if (ValidateDateRange())
                {
                    if (PreviewSummary() == true && deliveryMode.ToString() != KioskTransaction.KioskReceiptDeliveryMode.EMAIL.ToString())
                    {
        ...
        private void btnNewTab_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                inNewTab = true;
                pnlReprint.Visible = false;
                this.pnlFromToDates.Location = new System.Drawing.Point(3, 121);
        ...
        private void btnRePrintTab_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                this.pnlReprint.Location = new System.Drawing.Point(3, 121);
                this.pnlFromToDates.Location = new System.Drawing.Point(3, 286);
                inNewTab = false;
