    ...
    public partial class frmCheckInCheckOutQtyScreen : BaseFormKiosk
    {
        ...
        private void btnProceed_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                foreach (usrCtrlCheckinCheckoutProductsQty usrCtrl in flpComboProducts.Controls)
                {
        ...
        private void InitializeProductTab(List<ProductsContainerDTO> productsContainerList)
        {
            ...
            this.flpComboProducts.SuspendLayout();
            try
            {
                foreach (ProductsContainerDTO childProductsContainerDTO in productsContainerList)
                {
                    ...
                    //usrCtrlComboChildProductsQty.Width = tlpComboProducts.Width - 300;
                    this.flpComboProducts.Controls.Add(usrCtrlComboChildProductsQty);
                }
            }
            catch (Exception ex)
            {
            ...
            {
                this.flpComboProducts.ResumeLayout(true);
            }
            log.LogMethodExit();
        }
        ...
        private void SetCustomizedFontColors()
        {
            ...
            try
            {
                ...
                this.bigVerticalScrollComboProducts.InitializeScrollBar(ThemeManager.CurrentThemeImages.ScrollDownEnabled, ThemeManager.CurrentThemeImages.ScrollDownDisabled, ThemeManager.CurrentThemeImages.ScrollUpEnabled, ThemeManager.CurrentThemeImages.ScrollUpDisabled);
