...
namespace Parafait_Kiosk
{
    public partial class frmSelectWaiverOptions : BaseFormKiosk
    {
        ...
        private void SetVirtualKeyboard()
        {
            ...
            try
            {
                virtualKeyboardController = new VirtualWindowsKeyboardController(pnlTrxOTP.Bottom + 350);
        ...
        private void SetCustomKeyboard()
        {
            ...
            try
            {
                customKeyboardController = new VirtualKeyboardController(pnlTrxOTP.Bottom + 350);
        ...
        private void SetCustomizedFontColors()
        {
            ...
            try
            {
                ...
                this.BackgroundImage = ThemeManager.GetBackgroundImage(ThemeManager.CurrentThemeImages.SelectWaiverOptionsBackgroundImage);
