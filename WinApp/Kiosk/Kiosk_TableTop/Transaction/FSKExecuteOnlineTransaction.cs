...
namespace Parafait_Kiosk
{
    public partial class FSKExecuteOnlineTransaction : BaseForm
    {
        ...
        private void SetTheme()
        {
            log.LogMethodEntry();
            KioskStatic.formatMessageLine(txtMessage, 26, ThemeManager.CurrentThemeImages.BottomMessageLineImage);
            this.BackgroundImage = ThemeManager.GetBackgroundImageTwo(ThemeManager.CurrentThemeImages.FSKExecuteOnlineTransactionBackgroundImage);
        ...
        private void ShowHideTransactionIDField()
        {
            ...
            if (!showTransactionIdField)
            {
                ...
                this.btnShowKeyPad.Location = new Point(this.btnGetTransactionDetails.Location.X + this.btnGetTransactionDetails.Width + 70, this.btnGetTransactionDetails.Location.Y - 22);
            }
            log.LogMethodExit();
        }
        ...
        private void SetVirtualKeyboard()
        {
            ...
            try
            {
                virtualKeyboardController = new VirtualWindowsKeyboardController(panelPurchase.Bottom);
        ...
        private void SetCustomKeyboard()
        {
            ...
            try
            {
                customKeyboardController = new VirtualKeyboardController(panelPurchase.Bottom);
        ...
        private void SetReceiptPrintOptions(KioskTransaction onlineTransaction)
        {
            ...
            try
            {
                ...
                {
                    onlineTransaction.RececiptDeliveryMode = KioskTransaction.KioskReceiptDeliveryMode.EMAIL;
                    //Invalid setup. Please set execute online receipt delivery mode as email.
                    string message = MessageContainerList.GetMessage(machineUserContext, 5255);
                    KioskStatic.logToFile(message);
                    frmOKMsg.ShowUserMessage(message);
                }
