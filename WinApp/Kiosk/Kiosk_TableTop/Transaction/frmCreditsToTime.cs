...
namespace Parafait_Kiosk.Transaction
{
    public partial class frmCreditsToTime : BaseFormKiosk
    {
        ...
        void init(string message)
        {
            ...
            this.BackgroundImage = ThemeManager.GetBackgroundImage(ThemeManager.CurrentThemeImages.HomeScreenBackgroundImage);
        ...
        private void ShowKeyPadAfterCardTap()
        {
            ...
            if (numPad == null)
            {
                ...
                NumberPadVarPanel.Location = new Point(panelCardDetails.Right, panelCardDetails.Top );
                //NumberPadVarPanel.Location = new Point((this.Width - NumberPadVarPanel.Width) / 3, btnPrev.Bottom - 350);
