...
namespace Parafait_Kiosk
{
    public partial class frmCardCount : BaseFormKiosk
    {
        ...
        private void SetCardCountButtons()
        {
            ...
            if (_MaxCards > 9)
                btnTen.Visible = true;
            AdjustButtonLocation(_MaxCards);
            //if (_MaxCards < 5)
            //{
        ...
        private void AdjustButtonLocation(int maxCard)
        {
            log.LogMethodEntry(maxCard);
            if(maxCard == 2)
            {
                flpCardCount.Size = new System.Drawing.Size(730, 275);
                flpCardCount.Location = new System.Drawing.Point(625, 360);
            }
            else if(maxCard == 3)
            {
                this.flpCardCount.Size = new System.Drawing.Size(1075, 275);
                this.flpCardCount.Location = new System.Drawing.Point(460, 360);
            }
            else if(maxCard == 4)
            {
                flpCardCount.Size = new System.Drawing.Size(685, 600);
                flpCardCount.Location = new System.Drawing.Point(613, 214);
            }
            else if (maxCard == 5 || maxCard == 6)
            {
                flpCardCount.Size = new System.Drawing.Size(1010, 600);
                flpCardCount.Location = new System.Drawing.Point(455, 214);
            }
            else if (maxCard == 7 || maxCard == 8)
            {
                flpCardCount.Size = new System.Drawing.Size(1360, 600);
                flpCardCount.Location = new System.Drawing.Point(280, 214);
            }
            else
            {
                flpCardCount.Location = new System.Drawing.Point(125, 214);
                flpCardCount.Size = new System.Drawing.Size(1680, 600);
            }
            log.LogMethodExit();
        }
