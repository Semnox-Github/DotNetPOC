...
*2.152.0.0   8-Dec-2023       Suraj Pai           Modified for Attraction Sale in TableTop Kiosk
 ********************************************************************************************/
using System;
using System.Data;
    ...
    public partial class frmChooseProduct : BaseFormKiosk
    {
        ...
        public frmChooseProduct(KioskTransaction kioskTransaction, string pFunction, string entitlementType, string displayGroup = "ALL", string cardNum = "")
        {
            ...
            try
            {
                ...
                btnScrollRight.BackgroundImage = ThemeManager.CurrentThemeImages.ScrollRightButton;
        ...
        private void InitializeDisplayGroups()
        {
            ...
            try
            {
                this.btnPrev.Location = new System.Drawing.Point(674, btnPrev.Location.Y);
                this.btnCancel.Location = new System.Drawing.Point(990, btnCancel.Location.Y);

                btnProceed.Visible = false;
                btnVariable.Visible = false;
                SetDefaultButtonLocations();
                ...
                AdjustFlpLocation(displayGroupDataTbl.Rows.Count);
                ...
                for (int i = 0; i < displayGroupDataTbl.Rows.Count; i++)
                {
                    ...
                    //displayPanel.Width = flpCardProducts.Width - 430;
        ...
        private void AdjustFlpLocation(int count)
        {
            log.LogMethodEntry(count);
            this.flpCardProducts.SuspendLayout();
            if (count == 1)
            {
                this.btnSampleName.Margin = new System.Windows.Forms.Padding(30, 3, 3, 30);
                this.flpCardProducts.Size = new Size(380, 275);
                this.flpCardProducts.Location = new Point(775, 360);
            }
            else if (count == 2)
            {
                this.btnSampleName.Margin = new System.Windows.Forms.Padding(30, 3, 3, 30);
                this.flpCardProducts.Size = new Size(730, 275);
                this.flpCardProducts.Location = new Point(610, 360);
            }
            else if (count == 3)
            {
                this.btnSampleName.Margin = new System.Windows.Forms.Padding(30, 3, 3, 30);
                this.flpCardProducts.Size = new Size(1075, 275);
                this.flpCardProducts.Location = new Point(422, 360);
            }
            else if (count == 4)
            {
                this.btnSampleName.Margin = new System.Windows.Forms.Padding(30, 3, 3, 30);
                this.flpCardProducts.Size = new Size(710, 575);
                this.flpCardProducts.Location = new Point(595, 235);
            }
            else if (count == 5 || count == 6)
            {
                this.btnSampleName.Margin = new System.Windows.Forms.Padding(30, 3, 3, 30);
                this.flpCardProducts.Size = new Size(1075, 575);
                this.flpCardProducts.Location = new Point(422, 235);
            }
            else
            {
                this.btnSampleName.Margin = new System.Windows.Forms.Padding(30, 3, 3, 30);
                this.flpCardProducts.Size = new Size(1390, 575);
                this.flpCardProducts.Location = new Point(246, 235);
            }

            this.flpCardProducts.ResumeLayout(true);
            log.LogMethodExit();
        }
        ...
        private void btnScrollRight_Click(object sender, EventArgs e)//Starts:Modification on 17-Dec-2015 for introducing new theme
        {
            ...
            try
            {
                ...
                if (flpCardProducts.Controls.Count > (flpCardProducts.Width / flpCardProducts.Controls[0].Width))
                {
                    if (productScrollIndex == 1)
                    {
                        btnScrollLeft.Visible = false;
                    ...
                    int x = (flpCardProducts.Controls.Count % 2 == 1) ? 1 : 0;
                    int DownBound = (((flpCardProducts.Controls[0].Width + 1) * (((flpCardProducts.Controls.Count / 2) + x) - (flpCardProducts.Width / flpCardProducts.Controls[0].Width))) + 1);
                    if (DownBound <= productScrollIndex)
                    {
                        btnScrollRight.Visible = false;
                    }
        ...
        private void InitializeProductTab(string displayGroup, string entitlementType)
        {
            ...
            try
            {
                ...
                {
                    int xLoc = (this.Width / 2) - (btnPrev.Width / 2) - 1;
                    this.btnCancel.Location = new System.Drawing.Point(xLoc, btnCancel.Location.Y);
                    int xLoc2 = xLoc - btnPrev.Width - 119;
                    this.btnPrev.Location = new System.Drawing.Point(xLoc2, btnPrev.Location.Y);
                    int xLoc3 = xLoc + btnCancel.Width + 119;
                    this.btnProceed.Location = new System.Drawing.Point(xLoc3, btnProceed.Location.Y);
                ...
                try
                {
                    ...
                    AdjustFlpLocation(ProductTbl.Rows.Count);
                }
                catch (Exception ex)
                {
                ...
                for (int i = 0; i < ProductTbl.Rows.Count; i++)
                {
                    ...
                    else
                    {
                        ...
                        flpCardProducts.Controls.Add(ProductButton);
                    }
        ...
        private void DisableProductButtons()
        {
            ...
            try
            {
                ...
                List<Button> buttonList = flpCardProducts.Controls.OfType<Button>().ToList();
        ...
        private void SetDefaultButtonLocations()
        {
            log.LogMethodEntry();
            try
            {
                btnPrev.Location = new System.Drawing.Point(674, btnPrev.Location.Y);
                btnCancel.Location = new System.Drawing.Point(990, btnCancel.Location.Y);
                btnProceed.Location =
                    btnVariable.Location = new System.Drawing.Point(1159, btnProceed.Location.Y);
            }
            catch (Exception ex)
            {
                log.Error("Error while setting Default Location", ex);
                KioskStatic.logToFile("Error while setting Default Location in frmChoooseProduct: " + ex.Message);
            }
            log.LogMethodExit();
        }
        ...
        private void UpdateButtonLocations()
        {
            ...
            try
            {
                ...
                this.btnPrev.Location = new System.Drawing.Point(xLoc2, btnPrev.Location.Y);
                int xLoc3 = xLoc + btnCancel.Width + 119;
                this.btnVariable.Location = new System.Drawing.Point(xLoc3, btnProceed.Location.Y);
            }
            catch (Exception ex)
            {
                log.Error("Error while updating Location", ex);
                KioskStatic.logToFile("Error while updating Location in frmChoooseProduct: " + ex.Message);
            }
            log.LogMethodExit();
        }
    }
