...
namespace Parafait_Kiosk
{
    ...
    public partial class frmPaymentMode : BaseFormKiosk
    {
        ...
        public void AdjustflpPaymentModes()
        {
            log.LogMethodEntry();
            int xFactor = 360;
            int xLocSmall = 18;
            if (pOSPaymentModeInclusionDTOList != null && pOSPaymentModeInclusionDTOList.Any())
            {
                if (pOSPaymentModeInclusionDTOList.Count == 1)
                {
                    this.fLPPaymentModes.Size = new Size(xFactor * 1, this.fLPPaymentModes.Height);
                    this.fLPPaymentModes.Location = new Point(((this.Width - this.fLPPaymentModes.Width) / 2) - xLocSmall, this.fLPPaymentModes.Location.Y);
                }
                else if (pOSPaymentModeInclusionDTOList.Count == 2)
                {
                    this.fLPPaymentModes.Size = new Size(xFactor * 2, this.fLPPaymentModes.Height);
                    this.fLPPaymentModes.Location = new Point(((this.Width - this.fLPPaymentModes.Width) / 2) - xLocSmall, this.fLPPaymentModes.Location.Y);
                }
                else if (pOSPaymentModeInclusionDTOList.Count == 3)
                {
                    this.fLPPaymentModes.Size = new Size(xFactor * 3, this.fLPPaymentModes.Height);
                    this.fLPPaymentModes.Location = new Point((this.Width - this.fLPPaymentModes.Width) / 2, this.fLPPaymentModes.Location.Y);
                }
                else if (pOSPaymentModeInclusionDTOList.Count == 4)
                {
                    this.fLPPaymentModes.Size = new Size(xFactor * 4, this.fLPPaymentModes.Height);
                    this.fLPPaymentModes.Location = new Point((this.Width - this.fLPPaymentModes.Width) / 2, this.fLPPaymentModes.Location.Y);
                }
                else
                {
                    this.fLPPaymentModes.Size = new System.Drawing.Size(xFactor * 5, this.fLPPaymentModes.Height);
                    this.fLPPaymentModes.Location = new System.Drawing.Point(this.fLPPaymentModes.Location.X, this.fLPPaymentModes.Location.Y);
                }
            }
            log.LogMethodExit();
        }
        ...
        {
            log.LogMethodEntry();
            btnPayment.Margin = new System.Windows.Forms.Padding(45, 2, 0, 7);
            ...
            btnPayment.Font = new System.Drawing.Font(fontFamName, 15.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            btnPayment.ForeColor = System.Drawing.Color.White;
            //btnPayment.ImageAlign = System.Drawing.ContentAlignment.MiddleRight;
            btnPayment.Location = new System.Drawing.Point(0, 0);
            btnPayment.Size = new System.Drawing.Size(304, 109);
        ...
        private void btnPayment_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                txtMessage.Text = MessageContainerList.GetMessage(executionContext, ex.Message);
                frmOKMsg.ShowUserMessage(MessageContainerList.GetMessage(executionContext, ex.Message));
            }
            finally
            {
        ...
        private void DisplayValidtyMsg(int productId)
        {
            ...
            else
            {
                ...
                this.btnDiscount.Location = new System.Drawing.Point(btnDiscount.Location.X, 360);
            }
            log.LogMethodExit();
        }
        ...
        private void SetCustomizedFontColors()
        {
            ...
            try
            {
                ...
                this.BackgroundImage = ThemeManager.GetBackgroundImage(ThemeManager.CurrentThemeImages.PaymentModeBackgroundImage);
