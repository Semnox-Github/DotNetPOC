...
namespace Parafait_Kiosk
{
    public partial class frmPurchase : BaseFormKiosk
    {
        ...
        public void AdjustFlpLocation()
        {
            if (flpOptions.Controls.Count == 3)
            {
                for (int i = 0; i < flpOptions.Controls.Count; i++)
                {
                    ...
                    {
                        c.Size = new Size(550, 410);
                        c.Margin = new System.Windows.Forms.Padding(45, 145, 3, 3);
                    }
                }
            }
            else if (flpOptions.Controls.Count == 1)
            {
                for (int i = 0; i < flpOptions.Controls.Count; i++)
                {
                    ...
                    {
                        c.Size = new Size(550, 410);
                        c.Margin = new System.Windows.Forms.Padding(625, 145, 3, 3);
                    }
                }
            }
            else if (flpOptions.Controls.Count == 2)
            {
                for (int i = 0; i < flpOptions.Controls.Count; i++)
                {
                    Button c = flpOptions.Controls[i] as Button;
                    ...
                    {
                        c.Size = new Size(550, 410);
                        c.Margin = (i == 0) ? new System.Windows.Forms.Padding(315, 145, 3, 3) : new System.Windows.Forms.Padding(100, 145, 3, 3);
                    }
                }
            }
            else if (flpOptions.Controls.Count == 4)
            {
                for (int i = 0; i < flpOptions.Controls.Count; i++)
                {
                    Button c = flpOptions.Controls[i] as Button;
                    string type = c.GetType().ToString().ToLower();
                    flpOptions.Size = new System.Drawing.Size(1230, 749);
                    flpOptions.Location = new System.Drawing.Point(345, 87);
                    if (type.Contains("button"))
                    {
                        c.Size = new Size(440, 304);
                        c.Margin =  new System.Windows.Forms.Padding(117, 60, 3, 3);
                    }
                }
            }
            else if (flpOptions.Controls.Count == 5)
            {
                for (int i = 0; i < flpOptions.Controls.Count; i++)
                {
                    Button c = flpOptions.Controls[i] as Button;
                    string type = c.GetType().ToString().ToLower();
                    flpOptions.Size = new System.Drawing.Size(1440, 698);
                    flpOptions.Location = new System.Drawing.Point(240, 145);
                    if (type.Contains("button"))
                    {
                        c.Size = new Size(440, 304);
                        c.Margin = new System.Windows.Forms.Padding(30, 30, 3, 3);
                    }
                }
            }
        }
        ...
        private void SetCustomImages()
        {
            ...
            {
                this.SuspendLayout();
                this.BackgroundImage = ThemeManager.GetBackgroundImage(ThemeManager.CurrentThemeImages.PurchaseMenuBackgroundImage);
