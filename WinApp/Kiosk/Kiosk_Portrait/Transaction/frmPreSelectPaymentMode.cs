 ...
 *********************************************************************************************
 *2.150.1.0      30-Jan-2022     Sathyavathi    Created.
 ********************************************************************************************/
using System;
           ...
           foreach (PaymentModesContainerDTO paymentModeContainerDTO in paymentModesWithDisplayGroups)
            {
                ...
                else
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        if (paymentModeContainerDTO.IsCash)
                            btnPayment.BackgroundImage = ThemeManager.CurrentThemeImages.CashButtonImage;
                        else if (paymentModeContainerDTO.IsDebitCard)
                            btnPayment.BackgroundImage = ThemeManager.CurrentThemeImages.GameCardButton;
                        else if (paymentModeContainerDTO.IsCreditCard)
                            btnPayment.BackgroundImage = ThemeManager.CurrentThemeImages.CreditCardButton;
                        else
            ...
            try
            {
                foreach (Control c in fLPPaymentModes.Controls)
                {
                    ...
                    if (type.Contains("button"))
                    {
                        ...
                        ((Button)c).TextAlign = KioskStatic.GetContextAligment(KioskStatic.CurrentTheme.PaymentModeButtonTextAlignment);
                    }
                }
