...
*2.150.1.0   13-Feb-2023      Sathyavathi        modified for cart changes
...
namespace Parafait_Kiosk
{
    public partial class frmCalender : BaseFormKiosk
    {
        ...
        private bool allowFutureDate;

        internal DateTime DateTime { get { return dateTime; } set { } }

        public frmCalender(DateTime dateTime, bool showDate, bool allowEditDay, bool allowEditMonth, bool allowEditYear, bool showTime, bool allowEditTime, bool allowFutureDate)
        {
            log.LogMethodEntry(dateTime, showDate, showTime, allowEditDay, allowEditMonth, allowEditYear, allowEditTime, allowFutureDate = true);
            InitializeComponent();
        ...
        private void btnSave_Click(object sender, EventArgs e) //OK button click
        {
            ...
            try
            {
                ...
                if (day > 0 && month > 0 && year > 0)
                {
                    ...
                    if (allowFutureDate == false && DateTime.Compare(selectedDate, KioskStatic.Utilities.getServerTime()) > 0)
                    {
