...
namespace Parafait_Kiosk
{
    public partial class frmAttractionQty : BaseFormKiosk
    {
        ...
        public frmAttractionQty(KioskTransaction kioskTransaction, int productId)
        {
            ...
            {
                pnlComboDetails.Visible = false;
                pnlQuantity.Location = new Point(15, 550);
            }
        ...
        private void SetOnscreenMessages()
        {
            ...
            {
                UpdateQtyInfoOnScreen(qtySelected);
                txtQty.Text = lblYourSelectionsQty.Text = qtySelected.ToString();
        ...
        {
            log.LogMethodEntry();
            txtQty.Text = lblYourSelectionsQty.Text = value.ToString();
            log.LogMethodExit();
        }
        ...
        private void SetCustomImages()
        {
            ...
            try
            {
                ...
                this.pnlYourSelections.BackgroundImage = ThemeManager.CurrentThemeImages.PanelYourSelections;
