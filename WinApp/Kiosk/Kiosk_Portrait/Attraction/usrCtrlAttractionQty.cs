...
{
    public partial class usrCtrlAttractionQty : UserControl
    {
        private static readonly Semnox.Parafait.logging.Logger log = new Semnox.Parafait.logging.Logger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        private ProductsContainerDTO comboChildProdsContainerDTO;
        internal delegate void SelctedQuantity(usrCtrlAttractionQty usrCtrlComboChildProductsQty);
        ...
        public usrCtrlAttractionQty(ExecutionContext executionContext, int productId)
        {
        ...
        private void SetBackgroundImage(ProductsContainerDTO productsContainerDTO)
        {
            ...
            if (productsContainerDTO.ImageFileName.ToString().Trim() != string.Empty)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    this.usrControlPanel.BackgroundImage = KioskStatic.CurrentTheme.ChooseProductButton;
                }
            }
            else
            {
        ...
        private void SetDisplayElements(ProductsContainerDTO productsContainerDTO)
        {
            ...
            try
            {
                btnSampleProduct.Name = productsContainerDTO.ProductName;
                ...
                btnSampleProduct.Text = productsContainerDTO.ProductName;
                ...
                {
                    lblAgeCriteria.Text = MessageContainerList.GetMessage(KioskStatic.Utilities.ExecutionContext, 4778, productsContainerDTO.AgeUpperLimit);//below 18 yrs
                }
        ...
        internal void HideProductName()
        {
            log.LogMethodEntry();
            usrControlPanel.Visible = false;
            pnlQty.Location = new Point(328, 44);
            panelAgeCriteria.Location = new Point(331, 0);
            log.LogMethodExit();
        }
    }
}
