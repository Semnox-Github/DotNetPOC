 ...
 ********************************************************************************************* 
 *2.70.2      26-Nov-2019      Guru S A           Created for Waivers phase 2 enhancement changes  
        ...
        private void BuildWaiverDetails()
        {
            ...
            for (int i = 0; i < waiverSetDTO.WaiverSetDetailDTOList.Count; i++)
            {
                ...
                Label lblWaiverName = new Label()
                {
                    ...
                    MinimumSize = new Size(240, elementHeight),
                    Size = new Size(240, elementHeight),
                ...
                Label lblValidityDays = new Label()
                {
                    ...
                    Font = lblWaiverSetName.Font,
                    MinimumSize = new Size(70, elementHeight),
                    TextAlign = ContentAlignment.MiddleCenter
                }; 
                lblValidityDays.Size = new Size(70, lblWaiverName.Height);
                ...
                Button btnViewWaiver = new Button()
                {
                    ...
                    TextAlign = ContentAlignment.MiddleLeft,
                    MinimumSize = new Size(88, elementHeight),
                    Size = new Size(88, lblWaiverName.Height),
