 ...
 ********************************************************************************************* 
 *2.70.2      18-Oct-2019    Dakshakh raj            Created for Waiver phase 2 enhancement changes  
    ...
    public partial class frmLinkRelatedCustomer : BaseForm
    {
        ...
        private void SetCustomizedFontColors()
        {
            ...
            try
            {
                ...
                this.BackgroundImage = ThemeManager.GetBackgroundImage(ThemeManager.CurrentThemeImages.LinkRelatedCustomerBackgroundImage);
