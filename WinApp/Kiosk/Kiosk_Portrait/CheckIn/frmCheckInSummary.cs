...
*********************************************************************************************
*2.150.0.0   18-Oct-2021      Sathyavathi        Created for Check-In feature Phase-2
    ...
    public partial class frmCheckInSummary : BaseFormKiosk
    {
                ...
                if (panelPassportCoupon.Visible == true)
                {
                    foreach (ProductQtyMappingDTO product in purchaseProductDTO.ProductQtyMappingDTOs)
                    {
                        ...
                        if (qty > 0 && tl != null)
                        {
                            ...
                            //usrCtrlCheckInSummary.LblTax = string.Empty;
                            if (tl.LineAmount > 0)
                            {
                    ...
                    flpPassportCoupon.ResumeLayout();
                }
            }
            catch (Exception ex)
            {
        ...
        private void UpdateSummaryPanelForCombo()
        {
            ...
            try
            {
                ...
                flpSummaryDetails.SuspendLayout();
                ...
                flpSummaryDetails.ResumeLayout();
