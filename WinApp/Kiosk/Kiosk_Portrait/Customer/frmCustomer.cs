 ...
 *2.70.2      12-Dec-2019      Girish Kundar      Modified :for Domain name validation changes  
...
namespace Parafait_Kiosk
{
    public partial class Customer : BaseFormKiosk
    {
        ...
        private void SetVirtualKeyboard()
        {
            ...
            try
            {
                virtualKeyboardController = new VirtualWindowsKeyboardController(flpCustomerMain.Top);
        ...
        private void SetCustomKeyboard()
        {
            ...
            try
            {
                customKeyboardController = new VirtualKeyboardController(flpCustomerMain.Top);
