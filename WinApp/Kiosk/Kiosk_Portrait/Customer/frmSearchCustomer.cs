...
namespace Parafait_Kiosk
{
    public partial class frmSearchCustomer : BaseFormKiosk
    {
        ...
        private void SetVirtualKeyboard()
        {
            ...
            try
            {
                virtualKeyboardController = new VirtualWindowsKeyboardController(btnShowKeyPad.Top);
        ...
        private void SetCustomKeyboard()
        {
            ...
            try
            {
                customKeyboardController = new VirtualKeyboardController(btnShowKeyPad.Top);
        ...
        private void SetCustomiImages()
        {
            ...
            try
            {
                this.BackgroundImage = ThemeManager.GetBackgroundImage(ThemeManager.CurrentThemeImages.DefaultBackgroundImageTwo);
