 ...
 *2.130.0      26-Jun-2021    Girish Kundar        Modified :  Puncch Loyalty program Integration 
 ********************************************************************************************/
using System;
...
namespace Parafait_Kiosk
{
    public partial class frmLoyalty : BaseForm
    {
        ...
        private void frmLoyalty_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                pbLoyalty.Image = KioskStatic.CurrentTheme.LoyaltyFormLogoImage;
                if (pbLoyalty.Image == null)
            ...
            lblLoyaltyText.Text = KioskStatic.Utilities.MessageUtils.getMessage("Are you a More Cheese™ Rewards member?");
        ...
        private void SetBackGroundImage()
        {
            ...
            try
            {
                this.BackgroundImage = KioskStatic.CurrentTheme.LoyaltyBackGroundImage;
                btnLoyaltyYes.BackgroundImage = btnLoyaltyNo.BackgroundImage = KioskStatic.CurrentTheme.YesNoButtonImage;
                btnProceedWithoutLoyalty.BackgroundImage = btnLoyaltyNo.BackgroundImage = KioskStatic.CurrentTheme.YesNoButtonImage;
        ...
        void ShowKeyPad()
        {
            ...
            keypad.Location = new Point(panelPhoneNoInfo.Location.X + 77, (panelPhoneNoInfo.Bottom + (flpInfo.Height / 2) + panelPhoneNoInfo.Height)-178);
            keypad.Show();
            log.LogMethodExit();
        }
        ...
        private async void btnGo_Click(object sender, EventArgs e)
        {
            ...
            if (exitCount <= 0)
            {
                ...
                keypad.Hide();
                frmOKMsg fok = new frmOKMsg(KioskStatic.Utilities.MessageUtils.getMessage(1459));//Message : "Reward member not found. Please see front counter.");
                fok.ShowDialog();
                this.Close();
            }
            ...
            if (getmatch.Success)
            {
                ...
                catch (ValidationException vlex)
                {
                    ...
                    frmOKMsg fok = new frmOKMsg(KioskStatic.Utilities.MessageUtils.getMessage(3021));// Message:-"We’re sorry, rewards are not available at this time. Please see front counter.");
                    fok.ShowDialog();
