...
namespace Parafait_Kiosk.CardTransfer
{
    public partial class frmTransferFrom : BaseFormKiosk
    {
       ...
       // bool isPoints;
        public Card Card;
       // public string entitlement = string.Empty;
        ...
        private void frmTransferTokenFrom_FormClosing(object sender, FormClosingEventArgs e)
        {
            log.LogMethodEntry();
            //TimeOutTimer.Stop();
            Cursor.Hide();
        ...
        private void SetCustomizedFontColors()
        {
            ...
            try
            {
                ...
                this.textBoxMessageLine.ForeColor = KioskStatic.CurrentTheme.TransferFormFooterTextForeColor;//Footer text message
