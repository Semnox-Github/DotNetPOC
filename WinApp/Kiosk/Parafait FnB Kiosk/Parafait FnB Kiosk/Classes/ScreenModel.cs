/********************************************************************************************
* Project Name - Parafait_Kiosk -ScreenModel.cs
* Description  - ScreenModel 
* 
**************
**Version Log
**************
    ...
    public class ScreenModel
    {
        ...
        internal class UIPanel
        {
            ...
            internal UIPanelElement getElementByIndex(int index)
            {
                ...
                UIPanelElement uIPanelElement = new UIPanelElement();
                uIPanelElement = Elements.Find(x => x.ElementIndex == index);
        ...
        internal class UIPanelElement
        {
            ...
            internal UIPanelElement Clone()
            {
                log.LogMethodEntry();
                UIPanelElement uIPanelElement = new UIPanelElement();
                uIPanelElement = new UIPanelElement(UIPanelElementId,
                                            ElementName,
                                            Action,
                                            ActionScreenId,
                                            ElementIndex,
                                            ...
                                            Attribute.DisplayImage);
                log.LogMethodExit(uIPanelElement);
                return uIPanelElement; //Goody bag changes
            }
            ...
            internal ElementParameter getParameterById(int ParameterId)
            {
                ...
                elementParameter = Parameters.Find(x => x.ParameterId == ParameterId);
        ...
        internal class ElementParameter
        {
            ...
            internal ElementParameter Clone()
            {
                ...
                ElementParameter epClone = new ElementParameter(this.OwningElement,
                                                                ...
                                                                this.ActionScreenId,
                                                                this.ScreenGroup,
                                                                this.DisplayImage);//Goody bag changes

                epClone.ParentParameter = this.ParentParameter;
                epClone.Toplevel = this.Toplevel;
                epClone.ModifierSetId = this.ModifierSetId;
                epClone.FreeQuantity = this.FreeQuantity;
                epClone.identifier = this.identifier;
        ...
        internal UIPanel getPanelByIndex(int index)
        {
            ...
            uIPanel = UIPanels.Find(x => x.PanelIndex == index);
        ...
        public void Refresh()
        {
            ...
            using (Utilities utils = new Utilities())
            {
                DataTable dtScreen = utils.executeDataTable(@"select * from AppScreens where ScreenId = @screenId and AppScreenProfileId = (select AppScreenProfileId from AppScreenProfile where AppScreenProfileName = 'Parafait FnB Kiosk')",
