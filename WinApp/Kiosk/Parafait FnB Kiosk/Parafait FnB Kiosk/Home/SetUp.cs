/********************************************************************************************
* Project Name - Parafait_Kiosk -SetUp.cs
* Description  - SetUp 
* 
**************
**Version Log
    ...
    public partial class SetUp : Form
    {
        ...
        public SetUp()
        {
            ...
            flpLabels1.BackColor = flpLabels2.BackColor =
                flpValues1.BackColor = flpValues2.BackColor = Parafait_FnB_Kiosk.Common.PrimaryForeColor;
            log.LogMethodExit();
        }
        ...
        private void SetUp_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                loadConnectionInfo("Parafait FnB Kiosk");
                loadAppInfo("Parafait FnB Kiosk");
                Cursor.Show();
            }
            catch(Exception ex)
            {
        ...
        {
            log.LogMethodEntry();
            saveConnectionInfo("Parafait FnB Kiosk");
            saveAppInfo("Parafait FnB Kiosk");
           log.LogMethodExit();
        }
        ...
        private void btnTest_Click(object sender, EventArgs e)
        {
            log.LogMethodEntry();
            ExeConfigurationFileMap fileMap = new ExeConfigurationFileMap();
            fileMap.ExeConfigFilename = "Parafait FnB Kiosk.exe.config";  // relative path names possible
            ...
            try
            {
                ...
                conn.Open();
                conn.Close();
                Parafait_FnB_Kiosk.Common.ShowAlert("DB Connection successful");
            }
            catch (Exception ex)
            {
