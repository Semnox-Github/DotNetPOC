...
* Description  - manages the display of the queue
* 
**************
**Version Log
**************
...
*********************************************************************************************
* 2.80        23-Sep-2019      Jinto Thomas         Added logger for methods
********************************************************************************************/
using System;
    ...
    public class Player
    {
        ...
        public Player(int customerQueueId, ref string retMessage)
        {
            ...
            if (dtPlayerDetails.Rows.Count == 0)
            {
                ...
                log.LogVariableState("retMessage", retMessage);
            }
            else
            {
                                                ...
                                                where cg.last_update_date > DATEADD(dd,-1,getdate())
                                                  ...
                                                  and not exists
                                                    (select cusub.card_game_id
                                                      ...
                                                      where cusub.last_update_date > DATEADD(dd,-1,getdate())
                                                        and cg.card_game_id=cusub.card_game_id)";
