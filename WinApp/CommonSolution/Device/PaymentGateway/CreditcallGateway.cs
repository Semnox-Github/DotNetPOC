...
namespace Semnox.Parafait.Device.PaymentGateway
{
    ...
    public class CreditcallGateway
    {
        ...
        public bool doTransaction(Utilities utils,string amt, int refNo, string transType, string batchRef,string salesRef="", string langCode = "eng")
        {
            ...
            bool retValue = false;
            Semnox.Parafait.Device.PaymentGateway.CreditcallUI.frmUI ccui = new Semnox.Parafait.Device.PaymentGateway.CreditcallUI.frmUI(utils,amt, refNo, transType, batchRef,salesRef, langCode);
