...
namespace Semnox.Parafait.Device.Printer
{
    ...
    public class FamComm
    {
        ...
        {
            log.LogMethodEntry(nID_L, nID_H, nUType);
        ...
        {
            log.LogMethodEntry(nIDL, nIDH, nTemplateLength);
        ...
        {
            log.LogMethodEntry("nTemplateLength");
        ...
        {
            log.LogMethodEntry(param1, param2," nSensorState");
            ...
            get
            {
                ...
                switch (m_nErrorCode)
                {
                    ...
                    case FamDefs.RET_TOO_LITTLE_POINTS:
                        m_strErrorMessage = "Too little points!";
                        break;
