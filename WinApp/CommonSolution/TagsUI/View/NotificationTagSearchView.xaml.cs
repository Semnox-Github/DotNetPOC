...
{
    /// <summary>
    /// Interaction logic for NotificationTagSearchView.xaml
    /// </summary>
    public partial class NotificationTagSearchView : Window
    {
        ...
        /// </summary>
        public NotificationTagSearchView()
        {
            InitializeComponent();
        ...
        private void TagView_ContentRendered(object sender, EventArgs e)
        {
            ...
            {
                NotificationTagSearchVM notificationTagSearchVM = this.DataContext as NotificationTagSearchVM;

                if (notificationTagSearchVM != null)
                {
                    ExecutionContext executioncontext = notificationTagSearchVM.GetExecutionContext();
