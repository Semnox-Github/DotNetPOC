 ...
 * Description  - Send Email UI class
 * 
 **************
 **Version Log
 **************
    ...
    public partial class SendEmailUI : Form
    {
        ...
        private async void btnSend_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                log.LogVariableState("mailReplyTo", mailReplyTo);
                log.LogVariableState("smtpUsername", smtpUsername);
                //log.LogVariableState("smtpPassword", smtpPassword);
                log.LogVariableState("smtpHost", smtpHost);
                log.LogVariableState("smtpMailDomain", smtpMailDomain);
