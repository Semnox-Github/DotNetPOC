 ...
 * Description - EncryptedNumberColumn 
 * 
 * 
 **************
 **Version Log
...
namespace Semnox.Core.GenericUtilities
{
    ...
    /// </summary>
    public class EncryptedNumberColumn : NumberColumn
    {
        ...
        public EncryptedNumberColumn(string name, string hashedName, string displayName = null, string defaultValue = null, bool browsable = true) : base(name, displayName, defaultValue, browsable)
        {
