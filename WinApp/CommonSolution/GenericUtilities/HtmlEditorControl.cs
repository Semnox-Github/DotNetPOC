...
namespace Semnox.Core.GenericUtilities
{
    ...
    public sealed partial class HtmlEditorControl : UserControl
    {
        ...
        private void BrowserDocumentComplete(object sender, WebBrowserDocumentCompletedEventArgs e)
        {
            ...
            IOleCommandTarget.IOleCommandTarget target = null;
            ...
            try
            {
                ...
                target = (IOleCommandTarget.IOleCommandTarget)document;
            ...
            {
                log.Error("Error occured while executing BrowserDocumentComplete()" + ex.Message);
        ...
        public new bool Focus()
        {
            ...
            {
                // ignore errors
                log.Error("Error while executing Focus()" + ex.Message);
            }
            log.LogMethodExit(focus);
            return focus;
        ...
        {
            log.LogMethodEntry();
            log.LogMethodExit((base.BackColor != _defaultBackColor));
        ...
        {
            log.LogMethodEntry(url, newWindow);
            if (newWindow)
            {
        ...
        public void LoadFromUrl(string url)
        {
            ...
            try
            {
                ...
                if (IsStringEqual(maintype, "text") && IsStringEqual(subtype, "html"))
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        log.Error("Error while encoding" + ex.Message);
            ...
            catch (HtmlEditorException ex)
            {
                ...
                log.Error("Error occured while executing LoadFromUrl" + ex.Message);
                log.LogMethodExit(null, "Throwing Exception" + ex.Message);
                throw ;
            }
        ...
        {
            log.LogMethodEntry(imageLocation);
        ...
        {
            log.LogMethodEntry(styleSource);
            if (styleSource != null)
            {
        ...
        {
            log.LogMethodEntry(scriptSource);
        ...
        {
            log.LogMethodEntry();
            log.LogMethodExit(formatCommands);
        ...
        {
            log.LogMethodEntry(headingType);
            // obtain the selected range object
            mshtmlTextRange range = GetTextRange();
        ...
        {
            log.LogMethodEntry();
            using (Semnox.Core.GenericUtilities.HtmlEditor.FontAttributeForm dialog = new Semnox.Core.GenericUtilities.HtmlEditor.FontAttributeForm())
            {
                DefineDialogProperties(dialog);
        ...
        public HtmlFontProperty GetFontAttributes()
        {
            ...
            if (range != null)
            {
                ...
                HtmlFontProperty htmlFontProperty = new HtmlFontProperty(fontName, fontSize, fontBold, fontUnderline, fontItalic, fontStrikeout, fontSubscript, fontSuperscript);
                log.LogMethodExit(htmlFontProperty);
                return htmlFontProperty;
            }
            else
            {
                // no rnage selected so return null
                log.LogMethodExit(_defaultFont);
                return _defaultFont;
            }
        ...
        private bool IsFontBold(mshtmlTextRange range)
        {
            ...
            // determine the BOLD property
            object currentBold = QueryCommandRange(range, HTML_COMMAND_BOLD);
            bool isFontBold = (currentBold is System.Boolean) ? (bool)currentBold : _bodyFont.Bold;
            log.LogMethodExit(isFontBold);
            return isFontBold;
        ...
        public bool IsFontBold()
        {
            ...
            bool isFontBold = IsFontBold(range);
            log.LogMethodExit(isFontBold);
            return isFontBold;
        ...
        private bool IsFontUnderline(mshtmlTextRange range)
        {
            ...
            // determine the UNDERLINE property
            object currentUnderline = QueryCommandRange(range, HTML_COMMAND_UNDERLINE);
            bool isFontUnderline = (currentUnderline is System.Boolean) ? (bool)currentUnderline : _bodyFont.Underline;
            log.LogMethodExit(isFontUnderline);
        ...
        public bool IsFontUnderline()
        {
            ...
            mshtmlTextRange range = GetTextRange();
            // return the font property
            bool iSFontUnderline = IsFontUnderline(range);
            log.LogMethodExit(iSFontUnderline);
            return iSFontUnderline;
        ...
        private bool IsFontItalic(mshtmlTextRange range)
        {
            ...
            // determine the ITALIC property
            object currentItalic = QueryCommandRange(range, HTML_COMMAND_ITALIC);
            bool isFontItalic = (currentItalic is System.Boolean) ? (bool)currentItalic : _bodyFont.Italic;
            log.LogMethodExit(isFontItalic);
            return isFontItalic;
        ...
        public bool IsFontItalic()
        {
            ...
            // return the font property
            log.LogMethodExit();
            bool isFontItalic = IsFontItalic(range);
            log.LogMethodExit(isFontItalic);
            return isFontItalic;
        ...
        private bool IsFontStrikeout(mshtmlTextRange range)
        {
            ...
            // determine the STRIKEOUT property
            object currentStrikeout = QueryCommandRange(range, HTML_COMMAND_STRIKE_THROUGH);
            bool isFontStrikeout = (currentStrikeout is System.Boolean) ? (bool)currentStrikeout : _bodyFont.Strikeout;
            log.LogMethodExit(isFontStrikeout);
        ...
        public bool IsFontStrikeout()
        {
            ...
            mshtmlTextRange range = GetTextRange();
            // return the font property
            bool iSFontStrikeout = IsFontStrikeout(range);
            log.LogMethodExit(iSFontStrikeout);
            return iSFontStrikeout;
        ...
        private bool IsFontSuperscript(mshtmlTextRange range)
        {
            ...
            // determine the SUPERSCRIPT property
            object currentSuperscript = QueryCommandRange(range, HTML_COMMAND_SUPERSCRIPT);
            bool isFontSuperscript = (currentSuperscript is System.Boolean) ? (bool)currentSuperscript : false;
            log.LogMethodExit(isFontSuperscript);
            return isFontSuperscript;
        ...
        public bool IsFontSuperscript()
        {
            ...
            mshtmlTextRange range = GetTextRange();
            // return the font property
            bool isFontSuperscript = IsFontSuperscript(range);
            log.LogMethodExit(isFontSuperscript);
            return isFontSuperscript;
        ...
        private bool IsFontSubscript(mshtmlTextRange range)
        {
            ...
            // determine the SUBSCRIPT property
            object currentSubscript = QueryCommandRange(range, HTML_COMMAND_SUBSCRIPT);
            bool isFontSubscript = (currentSubscript is System.Boolean) ? (bool)currentSubscript : false;
            log.LogMethodExit(isFontSubscript);
            return isFontSubscript;
        ...
        public bool IsFontSubscript()
        {
            ...
            mshtmlTextRange range = GetTextRange();
            // return the font property
            bool isFontSubscript = IsFontSubscript(range);
            log.LogMethodExit(isFontSubscript);
            return isFontSubscript;
        ...
        private Color GetFontColor()
        {
            ...
            color = (fontColor is System.Int32) ? ColorTranslator.FromWin32((int)fontColor) : _bodyForeColor;
        ...
        {
            log.LogMethodEntry(findText);
            bool findFirst = FindFirst(findText, false, false);
            log.LogMethodExit(findFirst);
            return findFirst;
        ...
        {
            log.LogMethodEntry(findText, matchWhole, matchCase);
            // reset the text search range prior to making any calls
            FindReplaceReset();

            // calls the Find Next once search has been initialized

            bool findNext = FindNext(findText, matchWhole, matchCase);
            log.LogMethodExit(findNext);
            return findNext;
        ...
        {
            log.LogMethodEntry(findText);
            bool findNext = FindNext(findText, false, false);
            log.LogMethodExit(findNext);
            return findNext;
        ...
        {
            log.LogMethodEntry(findText, matchWhole, matchCase);
            bool findNext = (FindText(findText, matchWhole, matchCase) != null ? true : false);
            log.LogMethodExit(findNext);
            return findNext;
        ...
        {
            log.LogMethodEntry(findText, replaceText);
            bool findReplaceOne = FindReplaceOne(findText, replaceText);
            log.LogMethodExit(findReplaceOne);
            return findReplaceOne;
        ...
        {
            log.LogMethodEntry(findText, replaceText, matchWhole, matchCase);
        ...
        {
            log.LogMethodEntry(findText, replaceText);
            int findReplaceAll = FindReplaceAll(findText, replaceText, false, false);
            log.LogMethodExit(findReplaceAll);
            return findReplaceAll;
        ...
        {
            log.LogMethodEntry(tableProperties);
        ...
        public void TableInsertRow()
        {
            ...
            if (table != null && row != null)
            {
                ...
                {
                    log.Error("Error while executing TableInsertRow()" + ex.Message);
                    log.LogMethodExit(null, "Throwing Exception" + ex.Message);
        ...
        public void TableDeleteRow()
        {
            ...
            if (table != null && row != null)
            {
                ...
                {
                    log.Error("Error while executing TableDeleteRow()" + ex.Message);
                    log.LogMethodExit(null, "Throwing Exception" + ex.Message);
        ...
        {
            log.LogMethodEntry(table, tableProperties);
            try
            {
                ...
                if (tableCreated)
                {
                    ...
                    if (textRange != null)
                    {
                        ...
                        {
                            log.Error("Error while selecting the text range" + ex.Message);
                            log.LogMethodExit(null, "Throwing Exception" + ex.Message);
            ...
            catch (Exception ex)
            {
                ...
                log.Error("Error while executing ProcessTable() " + ex.Message);
                log.LogMethodExit(null, "Throwing Exception" + ex.Message);
        ...
        private void GetTableElement(out mshtmlTable table, out mshtmlTableRow row)
        {
            ...
            catch (Exception ex)
            {
                ...
                log.Error("Error while executing GetTableElement()" + ex.Message);
                table = null;
                row = null;
            }
            log.LogMethodExit();
        ...
        private bool ExecuteCommandQuery(string command)
        {
            ...
            mshtmlTextRange range = GetTextRange();
            bool executeCommandQuery = ExecuteCommandQuery(range, command);
            log.LogMethodExit(executeCommandQuery);
            return executeCommandQuery;
        ...
        {
            log.LogMethodEntry(range, command);
            ...
            catch (Exception ex)
            {
                ...
                log.Error("Error while executing ExecuteCommandQuery() " + ex.Message);
        ...
        {
            log.LogMethodEntry(command, data);
        ...
        {
            log.LogMethodEntry(range, command, data);
            try
            {
                if (range != null)
                {
            ...
            {
                // Unknown error so inform user
                log.Error("Error while executing ExecuteCommandRange() " + ex.Message);
                throw new HtmlEditorException("Unknown MSHTML Error.", command, ex);
            }
            log.LogMethodExit();
        ...
        {
            log.LogMethodEntry(command, prompt);
            try
            {
                // ensure command is a valid command and then enabled for the selection
            ...
            {
                // Unknown error so inform user
                log.Error("Error while executing ExecuteCommandDocument() " + ex.Message);
                throw new HtmlEditorException("Unknown MSHTML Error.", command, ex);
            }
            log.LogMethodExit();
        } // ExecuteCommandDocumentPrompt
        ...
        private object QueryCommandRange(string command)
        {
            ...
            // obtain the selected range object and execute command
            mshtmlTextRange range = GetTextRange();
            object queryCommandRange = new object();
            queryCommandRange = QueryCommandRange(range, command);
            log.LogMethodExit(queryCommandRange);
            return queryCommandRange;
        ...
        private object QueryCommandRange(mshtmlTextRange range, string command)
        {
            ...
            if (range != null)
            {
                ...
                {
                    // have unknown error so set return to null
                    log.Error("Error while executing QueryCommandRange"+ ex.Message);
                    retValue = null;
                }
            }
        ...
        private mshtmlTextRange GetTextRange()
        {
            ...
            {
                // have unknown error so set return to null
                log.Error("Error while executing GetTextRange" + ex.Message);
                range = null;
            }
            log.LogMethodExit(range);
            return range;
        ...
        private mshtmlElement GetFirstControl()
        {
            ...
            {
                // have unknown error so set return to null
                log.Error("Error while executing GetFirstControl()" + ex.Message);
                control = null;
            }
            log.LogMethodExit(control);
            return control;
        ...
        private mshtmlControlRange GetAllControls()
        {
            ...
            catch (Exception ex)
            {
                ...
                log.Error("Error while executing GetAllControls()" + ex.Message);
                range = null;
            }
            log.LogMethodExit(range);
            return range;
        ...
        {
            log.LogMethodEntry(stringValue, defaultValue);
        ...
        {
            log.LogMethodEntry(enumType, stringValue, defaultValue);
            ...
            {
                // default value will be returned
                log.Error("Error while executing TryParseEnum()" + ex.Message);
                result = defaultValue;
            }
        ...
        {
            log.LogMethodEntry(href);
            bool isValidHref = Regex.IsMatch(href, HREF_TEST_EXPRESSION, RegexOptions.IgnoreCase);
            log.LogMethodExit(isValidHref);
            return isValidHref;
        ...
        {
            log.LogMethodEntry(tagText, tagType);
            bool isStringEqual = (string.Compare(tagText, tagType, true) == 0) ? true : false;
            log.LogMethodExit(isStringEqual);
        ...
        private void RebaseAnchorUrl()
        {
            ...
            if (rebaseUrlsNeeded)
            {
                ...
                foreach (mshtmlElement element in anchors)
                {
                    ...
                    {
                        // ignore any errors
                        log.Error("Error Occured while executinng RebaseAnchorUrl()" + ex.Message);
                    }
                }
            }
            log.LogMethodExit();
        ...
        private void ProcessCommand(string command)
        {
            ...
            catch (HtmlEditorException ex)
            {
                ...
                log.Error("Error occured while exxecuting ProcessCommand()" + ex.Message);
