 ...
 * Description - EncryptedDateTimeColumn 
 * 
 * 
 **************
 **Version Log
...
namespace Semnox.Core.GenericUtilities
{
    ...
    /// date time column
    /// </summary>
    public class EncryptedDateTimeColumn : DateTimeColumn
    {
        ...
        public EncryptedDateTimeColumn(string name, string hashedName, string displayName = null, string defaultValue = null, bool browsable = true) : base(name, displayName, defaultValue, browsable)
        {
