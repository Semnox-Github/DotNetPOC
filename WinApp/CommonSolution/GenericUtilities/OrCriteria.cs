...
{
    /// <summary>
    /// complex criteria with logical or operator
    /// </summary>
    public class OrCriteria : ComplexCriteria
    {
        ...
        public OrCriteria(ColumnProvider columnProvider, SqlParameterNameProvider sqlParameterNameProvider, Criteria leftHandCriteria, Criteria rightHandCriteria) : base(columnProvider, sqlParameterNameProvider)
        {
