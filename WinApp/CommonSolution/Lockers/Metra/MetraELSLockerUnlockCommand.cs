 ...
 * Description  - Metra ELS Locker Unlock Command
 * 
 **************
 **Version Log
 **************
...
{
    public class MetraELSLockerUnlockCommand : MetraLockerUnlockCommand
    {
        private static readonly Semnox.Parafait.logging.Logger log = new Semnox.Parafait.logging.Logger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        /// <summary>
        /// Metra ELS Locker Unlock Command
        /// </summary>
        /// <param name="zoneCode"></param>
        /// <param name="lockerNo"></param>
        /// <param name="executionContext"></param>
        public MetraELSLockerUnlockCommand(string zoneCode, string lockerNo, ExecutionContext executionContext)
        ...
        /// <param name="executionContext"></param>
        protected MetraELSLockerUnlockCommand(string commandText, ExecutionContext executionContext)
