 ...
 * Description  - Metra ELS Locker BlackList Command Class
 * 
 **************
 **Version Log
 **************
...
{
    public class MetraELSLockerBlackListCommand : MetraLockerBlackListCommand
    {
        private static readonly Semnox.Parafait.logging.Logger log = new Semnox.Parafait.logging.Logger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        /// <summary>
        /// Metra ELS Locker BlackList Command
        /// </summary>
        /// <param name="cardNumber"></param>
        /// <param name="action"></param>
        /// <param name="executionContext"></param>
        /// <param name="lockerMake"></param>
        public MetraELSLockerBlackListCommand(string cardNumber, string action, ExecutionContext executionContext, string lockerMake)
