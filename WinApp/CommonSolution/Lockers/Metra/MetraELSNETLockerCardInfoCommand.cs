 ...
 * Description  - Metra ELS NET Locker CardInfo Command
 * 
 **************
 **Version Log
 **************
...
namespace Semnox.Parafait.Device.Lockers
{
    ...
    public class MetraELSNETLockerCardInfoCommand : MetraLockerCardInfoCommand
    {
        private static readonly Semnox.Parafait.logging.Logger log = new Semnox.Parafait.logging.Logger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        /// <summary>
        /// Metra ELS NET Locker CardInfo Command
        /// </summary>
        /// <param name="cardNumber"></param>
        /// <param name="executionContext"></param>
        public MetraELSNETLockerCardInfoCommand(string cardNumber, ExecutionContext executionContext)
