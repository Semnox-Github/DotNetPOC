 ...
 * Description  - Metra ELS Locker Erase Command
 * 
 **************
 **Version Log
 **************
...
{
    public class MetraELSLockerEraseCommand : MetraLockerEraseCommand
    {
        private static readonly Semnox.Parafait.logging.Logger log = new Semnox.Parafait.logging.Logger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        /// <summary>
        /// Metra ELS Locker Erase Command
        /// </summary>
        /// <param name="cardNumber"></param>
        /// <param name="executionContext"></param>
        public MetraELSLockerEraseCommand(string cardNumber,ExecutionContext executionContext)
