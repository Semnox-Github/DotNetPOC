...
namespace Semnox.Parafait.Device.Lockers
{
    ...
    /// </summary>
    public class MetraLockerDisableResponse : MetraLockResponse
    {
        private static readonly Semnox.Parafait.logging.Logger log = new Semnox.Parafait.logging.Logger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        /// <summary>
        /// MetraLockerDisableResponse
        /// </summary>
        /// <param name="response"></param>
        public MetraLockerDisableResponse(string response)
            : base(response)
        {
        ...
        /// <returns></returns>
        private string GetErrorMessage(string resultCode)
        {
