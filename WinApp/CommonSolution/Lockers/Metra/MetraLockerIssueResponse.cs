...
namespace Semnox.Parafait.Device.Lockers
{
    ...
    /// </summary>
    public class MetraLockerIssueResponse : MetraLockResponse
    {
        ...
        public MetraLockerIssueResponse(string response)
            :base(response)
        {
        ...
        public string GetErrorMessage(string resultCode)
        {
            ...
            switch (resultCode)
            {
                ...
                case "1"  : returnMessage = "ERROR_INVALID_FUNCTION - Operation is not allowed or Card is under blacklist"; break;
