...
namespace Semnox.Parafait.InventoryUI
{
    ...
    public partial class PurchaseOrderView : Window
    {
        ...
        public PurchaseOrderView()
        {
            ...
            this.ContentRendered += PurchaseOrderView_ContentRendered;
        }

        private void PurchaseOrderView_ContentRendered(object sender, EventArgs e)
        {
