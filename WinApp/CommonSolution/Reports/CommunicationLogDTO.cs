...
{
    /// <summary>
    /// This is the CommunicationLog data object class. This acts as data holder for the CommunicationLog business object
    /// </summary>
    public class CommunicationLogDTO
    {
        ...
        /// </summary>
        public CommunicationLogDTO(string masterAddress, string machineAddress, string receivedData, string lastSentData, DateTime timestamp, int machineId)
            :this()
        {
            log.LogMethodEntry(masterAddress, machineAddress, receivedData, lastSentData, timestamp, machineId);
        ...
        public CommunicationLogDTO(string masterAddress,string machineAddress,string receivedData,string lastSentData, DateTime timestamp,int machineId,DateTime lastUpdatedDate,
            ...
            :this(masterAddress, machineAddress, receivedData, lastSentData, timestamp, machineId)
        {
