...
namespace Semnox.Parafait.CardCore
{
    ...
    public class CardGamesDTO
    {
        ...
        {
            get { return validityStatus; }
            set { validityStatus = value; this.IsChanged = true; }
        }
