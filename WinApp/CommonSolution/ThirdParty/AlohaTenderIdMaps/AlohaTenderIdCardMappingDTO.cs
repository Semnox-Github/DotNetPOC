 ...
 * Description  - Data object of the AlohaTenderIDCardMappingDTO
 * 
 **************
 **Version Log
 **************
...
namespace Semnox.Parafait.ThirdParty
{
    ...
    /// </summary>
    public class AlohaTenderIdCardMappingDTO
    {
        ...
        /// </summary>
        public enum SearchByAlohaTenderIdCardMappingParameters
        {
            /// <summary>
            /// Search by ID field
            /// </summary>
        ...
        /// Default Contructor
        /// </summary>
        public AlohaTenderIdCardMappingDTO()
        {
            log.LogMethodEntry();
            id = -1;
            alohaMapId = -1;
        ...
        /// </summary>    
        public AlohaTenderIdCardMappingDTO(int id, int alohaMapId, int cardTypeId, int tenderId, bool isActive)
            :this()
        {
            log.LogMethodEntry(id, alohaMapId, cardTypeId, tenderId, isActive);
            this.id = id;
        ...
        /// </summary>    
        public AlohaTenderIdCardMappingDTO( int id, int alohaMapId, int cardTypeId, int tenderId, bool isActive, string createdBy, DateTime creationDate, 
                                            DateTime lastUpdatedDate, string lastUpdatedUser, string guid, int siteId, bool synchStatus, int masterEntityId)
            :this(id, alohaMapId, cardTypeId, tenderId, isActive)
        {
            log.LogMethodEntry( id,  alohaMapId,  cardTypeId,  tenderId,  isActive,  createdBy,  creationDate,lastUpdatedDate,
        ...
        /// <summary>
        /// Get/Set method of the TenderId field
        /// </summary>
        [DisplayName("TenderId")]
        public int TenderId { get { return tenderId; } set { tenderId = value; this.IsChanged = true; } }
