...
namespace Semnox.Parafait.ThirdParty
{
    ...
    public class LogWriter
    {
        ...
        private static string logDir = Directory.GetCurrentDirectory() + "\\Log\\";
        private static string logFile = "Parafait_ExactTarget_Log.txt";
        private static int maxLogAge = int.Parse("60");
