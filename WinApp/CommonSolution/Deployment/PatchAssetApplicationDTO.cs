 ...
 namespace Semnox.Parafait.Deployment
{
    ...
    /// </summary>
    public class PatchAssetApplicationDTO
    {
       Semnox.Parafait.logging.Logger log = new  Semnox.Parafait.logging.Logger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        ...
        /// </summary>
        public enum SearchByPatchAssetApplicationParameters
        {
            /// <summary>
        ...
        /// Default constructor
        /// </summary>
        public PatchAssetApplicationDTO()
        {
        ...
        /// </summary>
        public PatchAssetApplicationDTO(int patchAssetApplicationId, int assetId, int patchApplicationTypeId, string patchVersionNumber,
                                        string patchUpgradeStatus, string applicationPath, DateTime lastUpgradeDate, string isActive,
