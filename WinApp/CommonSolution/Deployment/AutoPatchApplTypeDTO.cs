...
namespace Semnox.Parafait.Deployment
{
    ...
    /// </summary>
    public class AutoPatchApplTypeDTO
    {
        ...
        /// </summary>
        public enum SearchByAutoPatchApplTypeParameters
        {
            /// <summary>
        ...
        /// </summary>
        public AutoPatchApplTypeDTO(int patchApplicationTypeId, string applicationType, string isActive, string createdBy,
