 ...
 *2.120.0     14-Feb-2021   Mushahid Faizan          Added null check condition in DYNAMIC LIST.
 *2.140.0     11-Jan-2022   Abhishek                 Modified:SaveUpdateSegmentValueList() to return the values 
 ********************************************************************************************/
...
namespace Semnox.Parafait.Category
{
    public class SegmentCategorizationValueWrapperBL
    {
                                ...
                                case "DYNAMIC LIST":
                                    {
                                        ...
                                        {
                                            if (!string.IsNullOrWhiteSpace(segmentDefinitionSourceValueDTOList[0].DBQuery))
        ...
        public List<SegmentCategorizationValueDTO> SaveUpdateSegmentValueList(List<SegmentCategorizationValueWrapperDTO> segmentCategorizationsList, int productId, string applicability)
        {
            try
            {
                ...
                foreach (SegmentCategorizationValueWrapperDTO segmentCategorizationValueWrapperDTO in segmentCategorizationsList)
                {
                    ...
                    else
                    {
                        ...
                        {
                            SegmentCategorizationValueDTO segmentCategorizationDTO = new SegmentCategorizationValueDTO();
                            segmentCategorizationDTO.SegmentValueDate = segmentCategorizationValueWrapperDTO.SegmentValueDate == null ? DateTime.MinValue : Convert.ToDateTime(segmentCategorizationValueWrapperDTO.SegmentValueDate);
                            if (segmentCategorizationValueWrapperDTO.SegmentCategoryId == 0)
                            {
                                segmentCategorizationDTO.SegmentCategoryId = -1;
                            }
