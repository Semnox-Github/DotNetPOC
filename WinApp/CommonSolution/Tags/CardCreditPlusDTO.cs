...
namespace Semnox.Parafait.Tags
{
    ...
    public class CardCreditPlusDTO
    {
        ...
        public CardCreditPlusDTO(int cardCreditPlusId, double creditPlus, string creditPlusType, string refundable, string remarks,
                                 ...
                                 int membershipRewardsId, int membershipId, TagValidityStatus validityStatus )
        {
        ...
        public TagValidityStatus ValidityStatus { get { return validityStatus; } set { validityStatus = value; this.IsChanged = true; } }
