/********************************************************************************************
 * Project Name - ProfileType DTO
 * Description  - Data object of ProfileType
 * 
 **************
 **Version Log
 **************
...
namespace Semnox.Parafait.Customer
{
    ...
    /// <summary>
    /// This is the ProfileType data object class. This acts as data holder for the ProfileType business object
    /// </summary>
    public class ProfileTypeDTO
    {
        ...
        /// </summary>
        public ProfileTypeDTO(int id, string name, string description, bool isActive)
            : this()
        {
        ...
        /// </summary>
        public ProfileTypeDTO(int id, string name, string description, bool isActive, string createdBy,
        ...
        /// <summary>
        /// Get/Set method of the Profile Type field
        /// </summary>
        ...
        public ProfileType ProfileType
        {
            get
            {
                ...
                try
                {
                    profileType = (ProfileType)Enum.Parse(typeof(ProfileType), name, true);
                }
                catch (Exception ex)
                {
                    log.Error("Error occured while parsing the profile type", ex);
                }
                return profileType;
            }
        }
