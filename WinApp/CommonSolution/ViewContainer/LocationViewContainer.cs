...
namespace Semnox.Parafait.Inventory.Location
{
    public class LocationViewContainer : AbstractViewContainer
    {
        ...
        internal List<LocationContainerDTO> GetLocationContainerDTOList()
        {
            log.LogMethodEntry();
            log.LogMethodExit(locationDTOCollection.LocationContainerDTOList);
            return locationDTOCollection.LocationContainerDTOList;
        }
        ...
        internal LocationViewContainer Refresh(bool rebuildCache)
        {
            log.LogMethodEntry();
            ...
            LastRefreshTime = DateTime.Now;
            LocationContainerDTOCollection latestLocationDTOCollection = GetLocationContainerDTOCollection(siteId, locationDTOCollection.Hash, rebuildCache);
