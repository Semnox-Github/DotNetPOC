...
namespace Semnox.Parafait.Inventory
{
    public class Authenticate
    {
        ...
        static private bool Login()
        {
            ...
            {
                log.Error("Error while executing Image operation in Login() " + ex.Message);
            }
            ...
            if (CommonFuncs.readerDevice != null)
            {
                CommonFuncs.readerDevice.Register(new EventHandler(CardScanCompleteEventHandle));
            }
        ...
        private static void CardScanCompleteEventHandle(object sender, EventArgs e)
        {
            ...
            if (e is DeviceScannedEventArgs)
            {
                ...
                TagNumber tagNumber;
                TagNumberParser tagNumberParser = new TagNumberParser(CommonFuncs.Utilities.ExecutionContext);
        ...
        static void formLogin_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            if (CommonFuncs.readerDevice != null)
            {
                CommonFuncs.readerDevice.UnRegister();
            }
            log.LogMethodExit();
        }
        ...
        static bool checkLogin(string CardNumber = null)
        {
            ...
            {
                log.Error("Error while executing checkLogin()" + ex.Message);
       ...
       **/
        ...
        //static public bool Manager()
        //{
        //    if (CommonFuncs.ParafaitEnv.Manager_Flag == "Y")
        //        return true;
