...
*2.130.0     07-Aug-2021    Deeksha                 Modified :Attendance Pay Rate changes
 ********************************************************************************************/
using System;
...
namespace Semnox.Parafait.User
{
    ...
    public class AttendanceLogDTO
    {
        ...
        public static string AttendanceLogStatusToString(AttendanceLogStatus logStatus)
        {
            log.LogMethodEntry(logStatus);
            string returnString;
            switch (logStatus)
            {
                case AttendanceLogStatus.CLOCK_IN:
                    returnString = "Clock In";
                    break;
                case AttendanceLogStatus.CLOCK_OUT:
                    returnString = "Clock Out";
                    break;
                case AttendanceLogStatus.ON_BREAK:
                    returnString = "On Break";
                    break;
                case AttendanceLogStatus.BACK_FROM_BREAK:
                    returnString = "Back from Break";
                    break;
                default:
                    returnString = null;
                    break;
        ...
        public AttendanceLogDTO(int id, string cardNumber, int readerId, DateTime timestamp, string type,
                                ...
                                int userId, string remarks , string notes)
            : this()
        {
        ...
        public AttendanceLogDTO(int id, string cardNumber, int readerId, DateTime timestamp, string type,
            ...
            : this(id, cardNumber, readerId, timestamp, type, attendanceId, mode, attendanceRoleId,
                  attendanceRoleApproverId, status, machineId, pOSMachineId, tipValue, isActive, originalAttendanceLogId,
                   requestStatus, approvedBy, approvalDate, userId, remarks, notes)
        {
            log.LogMethodEntry(id, cardNumber, readerId, timestamp, type,
                                 attendanceId, mode, attendanceRoleId, attendanceRoleApproverId,
                                 status, machineId, pOSMachineId, tipValue, isActive,
                                 ...
                                 originalAttendanceLogId, requestStatus, approvedBy, approvalDate, notes);
        ...
        [ReadOnly(false)]
        public int AttendanceLogId { get { return id; } set { id = value; this.IsChanged = true; } }

        /// <summary>
        /// Get/Set method of the AttendanceId field
        /// </summary>
        [DisplayName("AttendanceId")]
        public int AttendanceId { get { return attendanceId; } set { attendanceId = value; this.IsChanged = true; } }
        ...
        public int ReaderId { get { return readerId; } set { readerId = value; this.IsChanged = true; } }
        ...
        /// </summary>
        [DisplayName("Mode")]
        public string Mode { get { return mode; } set { mode = value; this.IsChanged = true; } }

        /// <summary>
        /// Get/Set method of the AttendanceRoleId field
        /// </summary>
        [DisplayName("AttendanceRoleId")]
        public int AttendanceRoleId { get { return attendanceRoleId; } set { attendanceRoleId = value; this.IsChanged = true; } }
        ...
        public int AttendanceRoleApproverId { get { return attendanceRoleApproverId; } set { attendanceRoleApproverId = value; this.IsChanged = true; } }
        ...
        public double TipValue { get { return tipValue; } set { tipValue = value; this.IsChanged = true; } }

        /// <summary>
        /// Get/Set method of the IsActive field
        /// </summary>
        [DisplayName("Is Active")]
        public string IsActive { get { return isActive; } set { this.IsChanged = true; isActive = value; } }
        ...
        public int OriginalAttendanceLogId { get { return originalAttendanceLogId; } set { originalAttendanceLogId = value; this.IsChanged = true; } }

        /// <summary>
        /// Get/Set method of the RequestStatus field
        /// </summary>
        [DisplayName("RequestStatus")]
        public string RequestStatus { get { return requestStatus; } set { requestStatus = value; this.IsChanged = true; } }

        /// <summary>
        /// Get/Set method of the ApprovedBy field
        /// </summary>
        [DisplayName("ApprovedBy")]
        public string ApprovedBy { get { return approvedBy; } set { approvedBy = value; this.IsChanged = true; } }

        /// <summary>
        /// Get/Set method of the ApprovalDate field
        /// </summary>
        [DisplayName("ApprovalDate")]
        public DateTime? ApprovalDate { get { return approvalDate; } set { approvalDate = value; this.IsChanged = true; } }
