...
* Description  - Class for PeruFiscalizationDataHandler 
* 
**************
**Version Log
**************
...
{
    internal class PeruFiscalizationDataHandler: FiscalizationDataHandler
    {
        ...
        private const string SELECT_QRY = @"SELECT 'PERU' as fiscalization, th.TrxId as transactionId, th.trx_no as transactionNumber,
												    ...
												    (select top 1 Remarks + ': ' + Data 
													    ...
													    and ExSysName ='PeruFiscalization'
        ...
        internal PeruFiscalizationDataHandler(SqlTransaction sqlTransaction = null) : base(sqlTransaction)
        {
