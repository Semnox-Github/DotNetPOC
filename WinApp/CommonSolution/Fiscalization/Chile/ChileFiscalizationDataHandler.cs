...
* Description  - Class for ChileFiscalizationDataHandler 
* 
**************
**Version Log
**************
...
{ 
    internal class ChileFiscalizationDataHandler : FiscalizationDataHandler
    {
        ...
        private const string SELECT_QRY = @"SELECT 'CHILE' as fiscalization, th.TrxId as transactionId, th.trx_no as transactionNumber,
												    ...
												    (select top 1 Remarks + ': ' + Data 
													    ...
													    and ExSysName ='ChileFiscalization'
										  ...
										  from ( Select * from trx_header th 
												  where th.CreationDate > '01-Aug-2023' 
                                                    ...
                                                    and EXISTS (SELECT 1 
																  from TrxPOSPrinterOverrideRules tpor , POSPrinterOverrideOptions ppo, LookupView lv
															     where tpor.transactionId = th.TrxId
																   and tpor.POSPrinterOverrideOptionID = ppo.POSPrinterOverrideOptionId
																   and lv.LookupName='FISCAL_INVOICE_SETUP'
																   and lv.LookupValue = 'EligibleOverrideOptions'
																   and lv.Description like '%'+ppo.OptionName+'%' ) 
        ...
        internal ChileFiscalizationDataHandler(SqlTransaction sqlTransaction = null): base(sqlTransaction)
        {
