/********************************************************************************************
 * Project Name - Games
 * Description  - RemoteReaderConfigurationContainerDataService class to get the data  from API by doing remote call  
 *  
 **************
 **Version Log
 **************
...
{
    public class RemoteReaderConfigurationContainerDataService : RemoteDataService, IReaderConfigurationContainerDataService
    {
        private static readonly logging.Logger log = new logging.Logger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        private const string GET_URL = "/api/Game/ReaderConfigurationContainer";

        public RemoteReaderConfigurationContainerDataService(ExecutionContext executionContext)
