/********************************************************************************************
 * Project Name - RemoteGameProfileContainerDataService  Class
 * Description  - RemoteGameProfileContainerDataService class to get the data  from API by doing remote call  
 *  
 **************
 **Version Log
 **************
...
{
    public class RemoteGameProfileContainerDataService : RemoteDataService, IGameProfileContainerDataService
    {
        private static readonly logging.Logger log = new logging.Logger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        private const string GET_URL = "/api/Game/GameProfileContainer";

        public RemoteGameProfileContainerDataService(ExecutionContext executionContext)
